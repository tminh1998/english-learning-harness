...
| 2026-09-10 | 2026-W37 | #25 | drift · purge · hand over · chase up · stay up |
| 2026-09-11 | 2026-W37 | #26 | backoff · blast radius · sticking point · pitch · swamped |
| 2026-09-15 | 2026-W38 | #27 | heartbeat · dangling · quote · off the table · night owl |
| 2026-09-16 | 2026-W38 | #28 | ingest · quarantine · hash out · manage expectations · rain check |
| 2026-09-17 | 2026-W38 | #29 | single point of failure · load shedding · loose ends · on the same page · commute |
| 2026-09-18 | 2026-W38 | #30 | postmortem · runbook · due diligence · buffer · rush hour |
| 2026-09-21 | 2026-W39 | #31 | drain · fan-out · carve out · ground rules · settle in |
...
⚠️ **Cập nhật 2026-09-25:** vốn từ lên **175 từ**, nợ ôn tập lên **170/175 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #35 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 24/09 (eviction · cardinality · concession · draw the line · splurge), phần B bốc ngẫu nhiên bằng lệnh trúng outstanding · provision · sleep in · dangling · drag on · sanity check · run out of · ingest · propagate · onboarding · downstream · under the weather · circle back · accommodate · hash out · feature flag · sticking point · sort out · catch up · discrepancy — chạm cả lô cũ nhất (13/08) lẫn lô 23/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Hai ứng viên bị hard gate R1 loại trong buổi này: `checkpoint` (đụng `point` trong word family của `sticking point` · `pain point` · `single point of failure`) và `bottom line` (đụng `line` trong họ từ của `draw the line`, mới dạy hôm qua) — thay bằng `idle` và `de-risk`. Tuần 2026-W39 đã có 25 từ (21/09 → 25/09); W38 vẫn **chưa có điểm quiz** — sáu tuần liên tiếp như vậy. Mai là Thứ Bảy, ngày hợp để gõ tay `/kiem-tra` cho W38 và một buổi `/on-tap` cho lô cũ nhất (14/08 → 16/08).

⚠️ **Cập nhật 2026-09-24:** vốn từ lên **170 từ**, nợ ôn tập lên **165/170 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #34 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 23/09 (saturation · skew · on the fence · waive · binge-watch), phần B bốc ngẫu nhiên bằng lệnh trúng quote · fed up · resilient · put off · purge · breaking change · manage expectations · culprit · stateless · graceful degradation · off the table · downstream · dangling · immutable · contention · buffer · on track · backpressure · turnaround · hash out — chạm cả lô cũ nhất (13/08) lẫn lô 22/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Buổi này không có ứng viên nào bị hard gate R1 loại: cả năm từ (eviction · cardinality · concession · draw the line · splurge) grep sạch ngay lượt đầu — hai từ IT chọn ở tầng cache/monitoring chứ không phải nhóm lệnh gặp hằng ngày, đúng cảnh báo trong `memory/tu-da-biet-khong-day-lai.md`. Tuần 2026-W39 đã có 20 từ (21/09 → 24/09); W38 vẫn **chưa có điểm quiz** — sáu tuần liên tiếp như vậy. Muốn có điểm thật thì gõ tay `/kiem-tra` cho W38, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).

⚠️ **Cập nhật 2026-09-23:** vốn từ lên **165 từ**, nợ ôn tập lên **160/165 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #33 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 22/09 (shard · contention · contingency · scale back · show up), phần B bốc ngẫu nhiên bằng lệnh trúng spike · drag on · pain point · run errands · escalate · verbose · deliverable · drain · pencil in · hand over · backport · boilerplate · sign off · leeway · stay up · follow up · rush hour · commute · recap · hash out — chạm cả lô cũ nhất (13/08) lẫn lô 21/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Buổi này không có ứng viên nào bị hard gate R1 loại: cả năm từ (saturation · skew · on the fence · waive · binge-watch) grep sạch ngay lượt đầu — hai từ IT chọn ở tầng vận hành/dữ liệu chứ không phải nhóm lệnh gặp hằng ngày, đúng cảnh báo trong `memory/tu-da-biet-khong-day-lai.md`. Tuần 2026-W39 đã có 15 từ (21/09 → 23/09); W38 vẫn **chưa có điểm quiz** — sáu tuần liên tiếp như vậy. Muốn có điểm thật thì gõ tay `/kiem-tra` cho W38, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).

⚠️ **Cập nhật 2026-09-22:** cột mốc **160 từ**, nợ ôn tập lên **155/160 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #32 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 21/09 (drain · fan-out · carve out · ground rules · settle in), phần B bốc ngẫu nhiên bằng lệnh trúng bottleneck · scope creep · immutable · align · stateless · verbose · backport · sticking point · bandwidth · put up with · rain check · feasible · technical debt · iron out · purge · feature flag · dry run · deliverable · heartbeat · bump — chạm cả lô cũ nhất (14/08) lẫn lô 16/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Hai ứng viên bị hard gate R1 loại trong buổi này: `hang out` (đụng `hang` trong word family của `get the hang of`) và `fine print` (đụng `fine-grained` trong họ từ của `granular`) — thay bằng `show up` và `scale back`. `contention` là từ **dạy lại**: nó nằm trong bài 19/09 đã xoá hẳn hôm 21/09 nên đã trả khỏi `VOCAB_INDEX.md`, grep R1 sạch — cùng tiền lệ với `off the table` hồi 15/09. Tuần 2026-W39 đã có 10 từ (21/09 → 22/09); W38 vẫn **chưa có điểm quiz** — sáu tuần liên tiếp như vậy. Muốn có điểm thật thì gõ tay `/kiem-tra` cho W38, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).

⚠️ **Cập nhật 2026-09-21:** mở tuần **2026-W39**. **Bài Thứ Bảy 19/09 đã xoá hẳn** theo yêu cầu người học — bận, chưa học: gỡ file bài, gỡ 5 từ contention · telemetry · reservations · red tape · tag along khỏi `VOCAB_INDEX.md` và `REVIEW_QUEUE.md` (sau này được phép dạy lại), gỡ khỏi bảng ôn tuần `recap/2026-W38`, và sửa lại bài 21/09: lùi thành **buổi #31**, phần A ôn nhanh đổi sang 5 từ của buổi 18/09, `runbook` ở phần B bốc lại thành `fed up` cho khỏi trùng phần A, mẩu đọc thay từ cũ `contention` bằng `bottleneck`. Thứ Bảy 19/09 là ngày học theo lịch mà không học nên **streak đứt**: chuỗi dài nhất vẫn là 26 buổi (13/08 → 11/09), chuỗi hiện tại bắt đầu lại từ 21/09.

Vốn từ nay **155 từ** — nợ ôn tập **150/155 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #31 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 18/09 (postmortem · runbook · due diligence · buffer · rush hour), phần B bốc ngẫu nhiên bằng lệnh trúng purge · drag on · outstanding · stakeholder · discrepancy · stub · brittle · cold start · heartbeat · spare · rain check · get the hang of · worn out · stay up · align · fed up · edge case · bandwidth · pitch · hand over — chạm cả lô cũ nhất (14/08) lẫn lô 18/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Ba ứng viên bị hard gate R1 loại trong buổi này: `cut corners` (chữ `corner` nằm sẵn trong word family của `edge case`), `for the record` (đụng `track record` trong họ từ của `on track`) và `fall through` (đụng `through` trong họ từ của `walk through`) — thay bằng `carve out`, `ground rules` và `settle in`. Chủ nhật 20/09 routine đã sinh bảng ôn tuần cho W38 (nay còn **20 từ** sau khi xoá bài 19/09). W37 và W38 đều **chưa có điểm quiz** — sáu tuần liên tiếp như vậy; muốn có điểm thật thì phải gõ tay `/kiem-tra`, muốn nợ ôn giảm thật thì gõ `/on-tap` cho lô cũ nhất (14/08 → 16/08).

⚠️ **Cập nhật 2026-09-18:** cột mốc **150 từ** — nợ ôn tập lên **145/150 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #30 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 17/09 (single point of failure · load shedding · loose ends · on the same page · commute), phần B bốc ngẫu nhiên bằng lệnh trúng throttle · truncate · verbose · heads-up · deprecate · nail down · lead time · catch up · spin up · manage expectations · sign off · outstanding · run errands · action item · stateless · spare · backport · immutable · pencil in · under the weather — chạm cả lô cũ nhất (13/08) lẫn lô 16/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Hai ứng viên bị hard gate R1 loại trong buổi này: `wiggle room` (nằm sẵn trong word family của `leeway`) và `cut it close` (đụng `cut over` trong họ từ của `cutover`) — thay bằng `buffer` và `rush hour`. Tuần 2026-W38 đã có 20 từ (15/09 → 18/09); W37 vẫn **chưa có điểm quiz** — năm tuần liên tiếp như vậy. Mai là Thứ Bảy, ngày hợp để gõ tay `/kiem-tra` cho W37 và một buổi `/on-tap` cho lô cũ nhất (14/08 → 16/08).
...
⚠️ **Cập nhật 2026-09-16:** vốn từ lên **140 từ**, nợ ôn tập lên **135/140 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #28 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 15/09 (heartbeat · dangling · quote · off the table · night owl), phần B bốc ngẫu nhiên bằng lệnh trúng backoff · feature flag · deprecate · provision · brittle · bottleneck · onboarding · cutover · takeaway · run by · pitch · stateless · bandwidth · pain point · bear with · catch up · run out of · spin up · sticking point · align — chạm cả lô cũ nhất (13/08) lẫn lô 11/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Một ứng viên bị hard gate R1 loại trong buổi này: `red flag` (đụng `flag` trong word family của `feature flag`) — thay bằng `manage expectations`. Tuần 2026-W38 đã có 10 từ (15/09 → 16/09); W37 vẫn **chưa có điểm quiz** — năm tuần liên tiếp như vậy. Muốn có điểm thật thì gõ tay `/kiem-tra` cho W37, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).

⚠️ **Cập nhật 2026-09-15:** mở tuần **2026-W38**. **Hai bài đã xoá hẳn** theo yêu cầu người học — bận, chưa học: Thứ Bảy 12/09 (cascade · flush · firm up · off the table · call it a day) và Thứ Hai 14/09 (shard · observability · blocker · bottom line · take it easy). Đã gỡ file bài, gỡ 10 từ đó khỏi `VOCAB_INDEX.md` và `REVIEW_QUEUE.md` (sau này được phép dạy lại — `off the table` đã được dạy lại ngay buổi 15/09), và gỡ khỏi bảng ôn tuần `recap/2026-W37`. Thứ Bảy 12/09 và Thứ Hai 14/09 đều là ngày học theo lịch mà không học nên **streak đứt**: chuỗi dài nhất là 26 buổi (13/08 → 11/09), chuỗi hiện tại bắt đầu lại từ 15/09. Vốn từ nay **135 từ**, nợ ôn tập **130/135 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #27 (15/09) chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 11/09 (buổi thật liền trước), phần B bốc ngẫu nhiên bằng lệnh trúng leeway · wrap up · grab a bite · dry run · scope creep · edge case · chip in · truncate · feature flag · backfill · stay up · bear with · sleep in · outstanding · escalate · loop in · throughput · clarify · downstream · defer. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Tuần 2026-W37 khép lại với **25 từ** mà vẫn **chưa có điểm quiz** — năm tuần liên tiếp như vậy. Muốn có điểm thật thì gõ tay `/kiem-tra` cho W37, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).

⚠️ **Cập nhật 2026-09-11:** vốn từ lên **130 từ**, nợ ôn tập lên **125/130 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #26 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 10/09, phần B bốc ngẫu nhiên bằng lệnh trúng onboarding · idempotent · buy-in · lead time · prioritize · immutable · failover · bandwidth · follow up · short notice · sign off · sort out · narrow down · align · action item · graceful degradation · spare · recap · backpressure · drop by — chạm cả lô cũ nhất (13/08) lẫn lô 09/09. Nhưng khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Hai ứng viên bị hard gate R1 loại ngay trong buổi này: `wind down` (đụng `wind up` trong word family của `end up`) và `deal breaker` (đụng `break` trong word family của `breaking change`) — thay bằng `swamped` và `sticking point`. Tuần 2026-W37 đã có 25 từ (07/09 → 11/09); W36 vẫn **chưa có điểm quiz** — bốn tuần liên tiếp như vậy. Muốn có điểm thật thì gõ tay `/kiem-tra` cho W36, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).

⚠️ **Cập nhật 2026-09-10:** vốn từ lên **125 từ**, nợ ôn tập lên **120/125 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #25 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 09/09, phần B bốc ngẫu nhiên bằng lệnh trúng cold start · graceful degradation · verbose · technical debt · ballpark · pain point · feasible · awkward · bottleneck · push back · sort out · stub · prioritize · touch base · get the hang of · backward compatible · breaking change · wrap up · chip in · takeaway — chạm cả lô cũ nhất (13/08) lẫn lô 05/09. Nhưng khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Tuần 2026-W37 đã có 20 từ (07/09 → 10/09); W36 vẫn **chưa có điểm quiz** — bốn tuần liên tiếp như vậy. Muốn có điểm thật thì gõ tay `/kiem-tra` cho W36, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).
...
⚠️ **Cập nhật 2026-09-07:** mở tuần **2026-W37**, vốn từ lên **110 từ**, nợ ôn tập lên **105/110 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #22 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 05/09, phần B bốc ngẫu nhiên bằng lệnh trúng idempotent · milestone · truncate · accommodate · recap · cutover · deprecate · tentative · overhead · nail down · backward compatible · touch base · buy-in · leeway · deliverable · reach out · pain point · bottleneck · prioritize · iron out — chạm cả lô cũ nhất (13/08) lẫn lô 04/09. Nhưng khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Tuần 2026-W36 đã khép lại với **30 từ** (31/08 → 05/09) mà vẫn **chưa có điểm quiz** — bốn tuần liên tiếp như vậy. Chủ nhật 06/09 routine đã sinh bảng ôn `/on-tap-tuan`; muốn có điểm thật thì phải gõ tay `/kiem-tra` cho W36, muốn nợ giảm thật thì gõ `/on-tap` (lô cũ nhất 14/08 → 16/08).
