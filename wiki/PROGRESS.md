...
| Số buổi học          | 32                                                                                      |
| Streak hiện tại      | 6 buổi (từ 2026-09-15 — Thứ Bảy 12/09 và Thứ Hai 14/09 bận, không học, hai bài đã xoá nên chuỗi đứt; Chủ nhật là ngày nghỉ theo lịch, không tính đứt) |
| Streak dài nhất      | 26 buổi (2026-08-13 → 2026-09-11)                                                                                 |
| Buổi gần nhất        | 2026-09-21 (Thứ Hai) — buổi #32                                                         |
| Số quiz đã làm       | 0                                                                                       |
...
| 2026-09-19 | 2026-W38 | #31 | contention · telemetry · reservations · red tape · tag along |
| 2026-09-21 | 2026-W39 | #32 | drain · fan-out · carve out · ground rules · settle in |
...
⚠️ **Cập nhật 2026-09-21:** mở tuần **2026-W39**, vốn từ lên **160 từ** — nợ ôn tập lên **155/160 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #32 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 19/09 (contention · telemetry · reservations · red tape · tag along), phần B bốc ngẫu nhiên bằng lệnh trúng purge · drag on · outstanding · stakeholder · discrepancy · stub · brittle · cold start · heartbeat · spare · rain check · get the hang of · worn out · stay up · align · runbook · edge case · bandwidth · pitch · hand over — chạm cả lô cũ nhất (14/08) lẫn lô 18/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Ba ứng viên bị hard gate R1 loại trong buổi này: `cut corners` (chữ `corner` nằm sẵn trong word family của `edge case`), `for the record` (đụng `track record` trong họ từ của `on track`) và `fall through` (đụng `through` trong họ từ của `walk through`) — thay bằng `carve out`, `ground rules` và `settle in`. Chủ nhật 20/09 routine đã sinh bảng ôn tuần cho W38. W37 và W38 đều **chưa có điểm quiz** — sáu tuần liên tiếp như vậy; muốn có điểm thật thì phải gõ tay `/kiem-tra`, muốn nợ ôn giảm thật thì gõ `/on-tap` cho lô cũ nhất (14/08 → 16/08).

⚠️ **Cập nhật 2026-09-19:** vốn từ lên **155 từ** — nợ ôn tập lên **150/155 từ quá hạn**, vẫn toàn bộ ở bậc 1. Buổi #31 chạy luật R9 bản 25 từ: phần A hỏi lại 5 từ của buổi 18/09 (postmortem · runbook · due diligence · buffer · rush hour), phần B bốc ngẫu nhiên bằng lệnh trúng load shedding · race condition · bump · brittle · come across · iron out · stay up · scope creep · boilerplate · clarify · bring up · flaky · canary release · pain point · backport · resilient · dangling · tentative · sleep in · cutover — chạm cả lô cũ nhất (13/08) lẫn lô 17/09. Khối này vẫn là hỏi-tự-trả-lời trên trang nên **không có từ nào lên bậc**. Một ứng viên bị hard gate R1 loại trong buổi này: `circuit breaker` (chữ `break` nằm sẵn trong word family của `breaking change`) — thay bằng `contention`. Tuần 2026-W38 đã khép lại với **25 từ** (15/09 → 19/09); W37 vẫn **chưa có điểm quiz** — năm tuần liên tiếp như vậy. Mai là Chủ nhật, routine sẽ tự sinh bảng ôn `/on-tap-tuan` cho W38; muốn có điểm thật thì vẫn phải gõ tay `/kiem-tra` (W37 và W38 đều đang nợ), muốn nợ ôn giảm thật thì gõ `/on-tap` cho lô cũ nhất (14/08 → 16/08).
