...
| Chỉ số               | Giá trị                                                                                 |
| -------------------- | --------------------------------------------------------------------------------------- |
| Tổng số từ đã học    | 30                                                                                      |
| Phân bố              | IT 12 · Business 12 · Life 6                                                            |
| Số buổi học          | 6                                                                                       |
| Streak hiện tại      | 6 buổi (Chủ nhật 2026-08-16 là ngày nghỉ theo lịch — không tính đứt)                    |
| Streak dài nhất      | 6 buổi                                                                                  |
| Buổi gần nhất        | 2026-08-19 (Thứ Tư) — buổi #6                                                           |
| Số quiz đã làm       | 0                                                                                       |
...
⚠️ **Đáng chú ý:** tính tới 2026-08-19 đã có **25/30 từ quá hạn ôn** trong `REVIEW_QUEUE.md`, tất cả vẫn ở bậc 1 — mỗi ngày lại thêm 5 từ. Routine tự động chỉ sinh được từ mới; `/on-tap` và `/kiem-tra` cần user trả lời mới lên/xuống bậc được. Số từ đọng đã gấp rưỡi `review.maxPerSession` (15) — nên dành hẳn một buổi gõ `/on-tap` để giải quyết lô cũ nhất (08-14, 08-15) trước khi nó phình thêm, và Chủ nhật này gõ `/kiem-tra` cho tuần 2026-W34.
