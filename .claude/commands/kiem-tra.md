...
4. Ra đề 4 phần A/B/C/D theo `wiki/_templates/quiz.md` — **chỉ từ vựng, không có
   phần ngữ pháp** (harness bỏ ngữ pháp từ 2026-08-26).
...
6. User nộp bài → mở file key, chấm từng câu: đúng/sai, sai vì sao, cách nhớ đúng.
   ...
   **Phần D (đặt câu) chấm khác ba phần kia** — không có đáp án đúng-sai, chấm theo
   3 tiêu chí, mỗi câu nói rõ đạt/không đạt từng cái:
